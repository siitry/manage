                        ...
                        <el-menu  default-active="1" class="el-menu-vertical-demo" @open="handleOpen" @close="handleClose" background-color="#545c64" text-color="#fff" active-text-color="#ffd04b">
                            <el-menu-item index="home">
                                <!-- <template slot="title"> -->
                                    ...
                                    <span @click="home()">系统首页</span>
                                <!-- </template> -->
                            </el-menu-item>
                            <el-menu-item index="client">
                                <i class="el-icon-menu"></i>
                                <span slot="title" @click="client()">用户信息</span>
                            </el-menu-item>
                            <el-menu-item index="3">
                                <i class="el-icon-document"></i>
                                <span slot="title">导航三三</span>
                            </el-menu-item>
                            <el-menu-item index="4">
                                <i class="el-icon-setting"></i>
                                <span slot="title">导航四四</span>
                            </el-menu-item>
                        </el-menu>
                    </el-col>
                    </el-row>
